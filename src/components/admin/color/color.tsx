...
import { useGetSizesQuery, useRemoveSizeMutation } from "@/api/color";
  ...
  const handleSoftDelete = async (id: string) => {
    try {
      ...
      notification.success({
        message: "Success",
        description: "color soft deleted successfully!",
      });
      refetch();
    } catch (error) {
      notification.error({
        message: "Error",
        description: "color to soft delete size",
      });
    }
  };
